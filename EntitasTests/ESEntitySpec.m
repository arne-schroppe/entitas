...
SPEC_BEGIN(ESEntitySpec)
        ...
        describe(@"ESEntity", ^{
            ...
            it(@"should have the id 0 if it is initialized without an id", ^{
                entity = [[ESEntity alloc] init];
                [[theValue(entity.id) should] equal:theValue(0)];
            });
            ...
            context(@"when initialized", ^{
                ...
                beforeEach(^{
                    entity = [[ESEntity alloc] initWithId:1];
                ...
                it(@"should have an id", ^{
                    [[theValue(entity.id) should] equal:theValue(1)];
                });
